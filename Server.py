...
- Constant-time API key compare (hmac)
- Per-field size guards and clear validation errors
- MAX_CONTENT_LENGTH = 1 MB
- Flask app factory pattern with Flask-Limiter
- Minimal request logging (no raw text)
- Docstrings for major functions
- Exception capture around analysis step
- Demo output formatted as JSON
"""
